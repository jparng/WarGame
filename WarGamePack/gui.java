...
public class gui {
	...
	public gui() {
		...
		instructions.setText("  Welcome to the game of War! In this game, each player will start with 26 cards in their respective decks. Click the draw button to start each battle by drawing 1 card. The player with a card value that is higher (ACE - KING, with ACE being the lowest and KING being the highest) will take both cards and place them into their spoils deck. \r\n\r\n  In the event of a tie, the tied card and 1 extra card will be moved to the Tie Pool, and the next card drawn will determine who wins all of the cards. In case of multiple ties, the same steps will be repeated until one side wins the round.\r\n\r\n   The winner is declared when one player has no more cards left. If a tie occurs and one player has no more cards to wager, they will lose. ");
		...
		firstButton.setBounds(545, 566, 165, 47);
		...
		spoilsCount1.setBounds(52, 437, 97, 47);
